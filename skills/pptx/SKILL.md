---
name: pptx
description: "Use this skill any time the user wants to create, edit, read, or analyze a PowerPoint presentation (.pptx file). Trigger when the user wants to build slides from scratch, modify an existing deck, extract content from a presentation, or convert a presentation to another format. The deliverable must be a .pptx file or analysis of one."
...
**Use subagents** — even for 2-3 slides. Convert slides to images, then inspect with this prompt:
